...
echo ""
echo -e "                 \033[1;31mBy @SKYNETBRASIL\033[1;36m"
echo ""
...
sleep 5
cd /bin || exit
wget https://raw.githubusercontent.com/Skynetbrasil/MASTER/main/Modulos/initcheck > /dev/null 2>&1
wget https://raw.githubusercontent.com/Skynetbrasil/MASTER/main/Modulos/userscheck > /dev/null 2>&1
chmod 777 initcheck > /dev/null 2>&1
chmod 777 userscheck > /dev/null 2>&1
clear
mkdir /etc/rec > /dev/null 2>&1
echo -e 'By: @DrHlexx' > /etc/rec/licence
echo -e 'By: @DrHlexx' > /usr/lib/licence
mkdir /usr/lib/checkuser > /dev/null 2>&1
cd /usr/lib/checkuser || exit
rm checkuser.py > /dev/null 2>&1
wget https://raw.githubusercontent.com/Skynetbrasil/MASTER/main/Modulos/checkuser.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@SKYNETBRASIL\033[0m"
